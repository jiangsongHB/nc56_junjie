...
values (1, 0, '费用编码', '', 0, 1, 'cfyname->getColValue(bd_invbasdoc,invname,invcode,cfycode)', -1, '', 20, 'cfycode', 0, 'N', 1, 'Y', 'getcolvalue2(pub_sysinit , value, initcode,PO85, pk_org, 1002);cfyname->getColValue(bd_invbasdoc,invname,invcode,cfycode)', 0, '', '', '', 'N', 0, '<root><tab code="zgyf_table" showflag="N" listshowflag="N" /></root>', '40040503010000000000', '4004050301000000UZQV', '@@@@', 1, '', 'UC000-0003868', '', 'N', 1, 70, 'table', '暂估成本', 0, '2010-10-15 19:27:07', 'N', '', '', '', 1, 1, 'N', 1, '', 100);
--更新暂估处理模板

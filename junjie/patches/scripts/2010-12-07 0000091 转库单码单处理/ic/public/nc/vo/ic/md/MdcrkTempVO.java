...
/**
 * 码单出入库表 nc_mdcrk_temp 生成的VO对象
 * 
 * @author MeiChao
 * @createtime 2010-12-04 13:53:35
 */
public class MdcrkTempVO extends SuperVO {
	...
	public MdcrkTempVO(String pk_mdcrk) {
		// 为主键字段赋值:
		this.pk_mdcrk = pk_mdcrk;
	}

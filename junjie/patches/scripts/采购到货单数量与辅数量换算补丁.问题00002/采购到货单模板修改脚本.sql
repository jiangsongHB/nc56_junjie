...
;
update pub_billtemplet_b t set t.editformula='narrvnum->iif(convertrate==null,narrvnum,nassistnum*convertrate)' where t.pk_billtemplet='40040301010000000000'and t.table_name='基本信息' and t.itemkey='nassistnum'